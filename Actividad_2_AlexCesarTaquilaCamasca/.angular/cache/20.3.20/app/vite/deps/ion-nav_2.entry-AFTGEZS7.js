...
var Nav = class {
  ...
  componentDidLoad() {
    return __async(this, null, function* () {
      this.didLoad = true;
      this.rootChanged();
      this.gesture = (yield import("./swipe-back-BZBFwTQV-6MXZGX3A.js")).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
...
@ionic/core/dist/esm/ion-nav_2.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-nav_2.entry-AFTGEZS7.js.map
