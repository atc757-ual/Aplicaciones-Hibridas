...
import {
  transition
} from "./chunk-YK2PHTQE.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-GDN3IBGQ.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
...
} from "./chunk-BXVPGF2P.js";
import {
  shouldUseCloseWatcher
} from "./chunk-LZO7YZFO.js";
  ...
  componentDidLoad() {
    {
      this.rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-BtUdxPjv-AV6NKVNT.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-BfJqFSLF-JT5SBMHK.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-AaDhOpKN-2UYJJYRI.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CTe4XmL7-U7W7HAZX.js");
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BZBFwTQV-JVB64WH5.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-MLRJIKR2.js.map
